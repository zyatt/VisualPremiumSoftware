...
async function listarParaMovimentacao(filtros = {}) {
  ...
  return listarPaginado({
    ...
    pagina,
    porPagina,
    // Os diálogos de movimentação (Entrada/Saída, Produção) não expõem
    // ordenação na UI — mantemos nome asc, mesmo critério que a listagem
    // sem paginação usava por padrão, a menos que o cliente peça outra coisa.
